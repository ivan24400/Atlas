...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            // perform the user_content login attempt.
            showProgress(true);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                // Retrieve data rows for the device user_content's 'profile' contact.
                ...
                // a primary email address if the user_content hasn't specified one.
...
// Account exists, return true if the password matches.
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent user = new Intent(Login.this,User.class);
                startActivity(user);
            } else {
